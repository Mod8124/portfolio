...
export function handleToggleAccesibility(e) {
    ...
    if (modalAccesibility.classList.contains('active')) {
        btnAccesibility.querySelector('.accesibility__img').src = './assets/img/icons/icons/icon__close.svg';
    } else {
...
import { changeColor } from '../functions/handleBackground.js';
...
export function handleRestartColors(e) {
    ...
    rootELement.style.setProperty(
        `${nameColor}`,
        `${e.target.dataset.color === '--water_green' ? waterColor : orangeColor}`
    );
